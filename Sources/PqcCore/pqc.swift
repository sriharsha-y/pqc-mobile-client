...
//
// FROZEN to the last published release's ABI. Do NOT regenerate this file
// from a locally-changed src/pqc.udl just to make `git status` look clean —
// SPM consumers from `main` pin against the binaryTarget URL/checksum in
// Package.swift, which points at the PqcCore-X.Y.Z.xcframework.zip from
// THAT release. If this .swift binding drifts from that binary, UniFFI's
// FfiConverter reads the wrong byte counts at runtime and consumers crash.
//
// The `publish-swiftpm` CI job (.github/workflows/release.yml) refreshes
// this file by extracting pqc.swift from the just-uploaded release zip
// and force-moving the release tag to the resulting commit. Between
// releases, this file intentionally lags src/pqc.udl on `main`.
...
public struct HttpResponse {
    ...
    public var headers: [String: [String]]
    public var body: Data
    public var negotiatedNamedGroup: String
    public var negotiatedProtocol: String

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(status: UInt16, headers: [String: [String]], body: Data, negotiatedNamedGroup: String, negotiatedProtocol: String) {
        self.status = status
        self.headers = headers
        self.body = body
        self.negotiatedNamedGroup = negotiatedNamedGroup
...
extension HttpResponse: Equatable, Hashable {
    public static func ==(lhs: HttpResponse, rhs: HttpResponse) -> Bool {
        ...
        if lhs.negotiatedNamedGroup != rhs.negotiatedNamedGroup {
            return false
        }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(headers)
        hasher.combine(body)
        hasher.combine(negotiatedNamedGroup)
...
public struct FfiConverterTypeHttpResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> HttpResponse {
        return
            try HttpResponse(
                ...
                negotiatedNamedGroup: FfiConverterString.read(from: &buf), 
    ...
    public static func write(_ value: HttpResponse, into buf: inout [UInt8]) {
        ...
        FfiConverterString.write(value.negotiatedNamedGroup, into: &buf)
...
public struct PqcConfig {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(pinnedCertSha256: [String], enablePostQuantum: Bool, enableHttp3: Bool, defaultTimeoutMs: UInt64?) {
...
extension PqcConfig: Equatable, Hashable {
    public static func ==(lhs: PqcConfig, rhs: PqcConfig) -> Bool {
        ...
        if lhs.enableHttp3 != rhs.enableHttp3 {
            return false
        }
...
public struct FfiConverterTypePqcConfig: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PqcConfig {
        return
            try PqcConfig(
                ...
                enableHttp3: FfiConverterBool.read(from: &buf), 
    ...
    public static func write(_ value: PqcConfig, into buf: inout [UInt8]) {
        ...
        FfiConverterBool.write(value.enableHttp3, into: &buf)
...
public struct FfiConverterTypePqcError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PqcError {
        ...
        case 7: return .PinningFailure(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 8: return .TrustVerification(
            message: try FfiConverterString.read(from: &buf)
        )
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_pqc_client_checksum_method_pqchttpclient_request() != 35074) {
