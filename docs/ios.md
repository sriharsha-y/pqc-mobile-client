...
```ruby
pod 'PqcCore', '~> 0.5.4' # x-release-please-version
```
...
```ruby
pod 'PqcCore', :podspec => 'https://raw.githubusercontent.com/sriharsha-y/pqc-mobile-client/v0.5.4/PqcCore.podspec' # x-release-please-version
```
...
```swift
dependencies: [
    .package(url: "https://github.com/sriharsha-y/pqc-mobile-client.git", from: "0.5.4") // x-release-please-version
],
targets: [
    .target(
        name: "MyApp",
