...
library's PQC client and the Android system stack (`HttpsURLConnection`), so
...
<p align="center">
  <img src="screenshot.png" alt="PQC Native Android sample showing kex=X25519MLKEM768" width="300">
</p>
...
└── app/
    ...
    └── src/main/
        ...
        └── java/.../MainActivity.kt        # the toggle + result card + PQC call
```
